...
export const Contact = () => {
  ...
  useEffect(()=> {
    ...
    const handleSubmit = (event) => {
        ...
        if(!fnameRef.current.value || !lnameRef.current.value || !emailRef.current.value || !phoneRef.current.value || !messageRef.current.value) {
    ...
    return (
      <section data-aos="fade-down" data-aos-duration="1000" className="contact flex column">
        <h1>
          I would love to hear from you, <br /> Get in touch👋
        </h1>
        <section className="form-section flex column">
          <form ref={formRef} className="details-sec column flex wrap" onSubmit={handleSubmit}>
